  ...
  <div className="w-full min-h-dvh md:h-full bg-background relative overflow-hidden pt-14 pb-8 px-5 md:p-24 flex flex-col items-center justify-start md:justify-center">
    <div className="relative z-10 flex flex-col md:flex-row gap-6 md:gap-16 items-center w-full max-w-[1600px] mx-auto justify-center">
      <div className="flex-1 max-w-[700px]">
        ...
        <p className="text-sm md:text-xl text-on-visual-soft mb-6 md:mb-16 max-w-[700px]">
          We don't promise magic. We promise strong execution, real distribution, and momentum-building that you can see.
        </p>

        <p className="text-sm md:text-lg text-primary text-on-visual-accent font-medium mb-3 md:mb-6 tracking-wider uppercase">
        ...
        <div className="space-y-2 md:space-y-4">
          {outcomes.map((item, i) => (
            <GlassPanel key={i} variant="bright" className="p-3 md:p-5 flex items-center gap-3 md:gap-4">
              ...
              <p className="text-sm md:text-lg text-foreground/80">{item}</p>
            </GlassPanel>
          ))}
        </div>
      </div>
