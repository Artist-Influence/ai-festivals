  ...
  return (
    <div className="w-full min-h-dvh md:h-full bg-background relative overflow-hidden pt-14 pb-8 px-5 md:p-20 flex flex-col justify-start md:justify-center">
      ...
      <div className="relative z-10 w-full max-w-[1500px] mx-auto">
        <p className="t-eyebrow text-xs md:text-sm mb-2 md:mb-4">The Problem</p>
        <h1 className="text-2xl md:text-6xl t-hero text-on-visual mb-2 md:mb-4 max-w-[1300px]">
          {t('problem.title')}
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-5">
          {cards.map((i) => (
            <GlassPanel key={i} variant="bright" className="p-5 md:p-8">
              <p className="text-sm md:text-2xl t-h3 text-primary mb-2 md:mb-3">{t(`problem.card.${i}.label`)}</p>
